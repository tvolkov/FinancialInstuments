 ...
 */
public class CachedDatabaseMultiplierProvider implements MultiplierProvider {
    private static final Logger LOGGER = LoggerFactory.getLogger(CachedDatabaseMultiplierProvider.class);
    ...
    public CachedDatabaseMultiplierProvider(DatabaseQueryRunner databaseQueryRunner) {
        LOGGER.debug("creating CachedDatabaseMultiplierProvider");
